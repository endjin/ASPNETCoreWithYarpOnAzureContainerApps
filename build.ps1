...
#
$SolutionToBuild = (Resolve-Path (Join-Path $here ".\DotNetOnContainerApps.sln")).Path
$ContainersToBuild = @(
    @{
        Dockerfile = "./DotNetOnContainerApps.APIs.Catalog\Dockerfile"
        ImageName = "dotnetoncontainerappsapiscatalog"
        ContextDir = "."
    }
    @{
        Dockerfile = "./DotNetOnContainerApps.APIs.Orders\Dockerfile"
        ImageName = "dotnetoncontainerappsapisorders"
        ContextDir = "."
    }
    @{
        Dockerfile = "./DotNetOnContainerApps.APIs.UI\Dockerfile"
        ImageName = "dotnetoncontainerappsapisui"
        ContextDir = "."
    }
    @{
        Dockerfile = "./DotNetOnContainerApps.Proxy\Dockerfile"
        ImageName = "dotnetoncontainerappsproxy"
        ContextDir = "."
    }
)
